...
FractalNoiseGenerator::FractalNoiseGenerator(size_t octave_count, double persistance) :
...
Array2D<float> FractalNoiseGenerator::Generate(size_t width, size_t height) 
{
